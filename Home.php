...
<body>
    <div class="container">
        ...
        <section class="hero-section autoBlur">
            <div class="hero-vid">
                <video loop autoplay muted plays-inline class="hero-video" >
                    <source src="video/pro1.mp4" type="video/mp4">
                </video>
        ...
        <div class="autoBlur">
        <h1>Welcome</h1>
        <h1>Discover The Latest Games And Best Support !</h1>
        </div>

        <img class="stone-img" src="img/stones.png" alt="stone-image">
        <div class="image-box autoTakeFull">
        <img src="img/about.webp" alt="about-img">
        </div>
        <h4>Best Games With Latest Updates !<h4>
        <h4>Never Regreat !</h4>
        </section>
